...
;	warp_def 0, 7, 1, GROUP_TICKLE_WOODS, MAP_TICKLE_WOODS
;	warp_def 0, 7, 1, GROUP_BARRIER_CREATOR, MAP_BARRIER_CREATOR
	warp_def 0, 7, 1, GROUP_DEBUG_MAP, MAP_DEBUG_MAP
